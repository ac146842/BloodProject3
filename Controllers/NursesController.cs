...
namespace BloodProject3.Controllers
{
    public class NursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NurseID,UserID,JobRole,EmployedStartDate,LicenseNumber")] Nurse nurse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NurseID,UserID,JobRole,EmployedStartDate,LicenseNumber")] Nurse nurse)
        {
            if (id != nurse.NurseID)
            {
                return NotFound();
