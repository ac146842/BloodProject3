...
namespace BloodProject3.Migrations
{
    ...
    [Migration("20260921092604_AllUpdatedModels")]
    partial class AllUpdatedModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BloodProject3.Areas.Identity.Data.User", b =>
                {
            ...
            modelBuilder.Entity("BloodProject3.Models.Inventory", b =>
                {
                    ...
                    b.Property<int?>("DonatedBloodDonationID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DonatedBloodDonationID");
            ...
            modelBuilder.Entity("BloodProject3.Models.Inventory", b =>
                {
                    ...
                    b.HasOne("BloodProject3.Models.DonatedBlood", "DonatedBlood")
                        .WithMany()
                        .HasForeignKey("DonatedBloodDonationID");

                    b.Navigation("BloodType");

                    b.Navigation("DonatedBlood");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BloodProject3.Areas.Identity.Data.User", null)
                        .WithMany()
